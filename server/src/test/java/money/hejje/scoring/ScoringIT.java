...
class ScoringIT extends AbstractIntegrationTest {
    ...
    void scoreBreakdownSumsAndEndpointsRender() throws Exception {
        ...
        assertThat(adjustments).extracting(a -> (Object) a.get("name")).containsExactly("Technical compatibility", "Current regime", "Recent paper/live performance", "Event risk", "News context", "Live-vs-backtest drift");
