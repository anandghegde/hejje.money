 ...
 * read-only; {@code decisionsHash} is SHA-256 over the bot's decisions in the session; {@code confidenceCalibration} is the
 * bot's entry confidence against outcomes in the session (plan M9.2: {@code n}, {@code none}, {@code pending}, {@code brier},
 * {@code buckets}), null on reports made before it existed.
 */
public record SimReport(UUID id, UUID sessionId, String botName, String botVersion, String botKind, List<LocalDate> sessionDates, long capitalPaise,
        ...
        long frictionPaise, List<Double> tradeRs, String decisionsHash, String resultHash, Map<String, Object> snapshot, Map<String, Object> confidenceCalibration, Instant createdAt) {
