 ...
 * {@code entryTiming} are the review's trade cause (plan M9.6; UNKNOWN until classified). {@code horizon} is INTRADAY or
 * SWING and {@code holdingDays} the sessions held after the entry session (0 intraday; plan M11.1).
 */
public record TradeFact(UUID entryOrderId, UUID instrumentId, String instrument, UUID strategyId, String strategy, String family, Instant openedAt,
        ...
        Boolean setupValid, int hour, String cause, String entryTiming, String horizon, int holdingDays) {
    ...
    public TradeFact(UUID entryOrderId, UUID instrumentId, String instrument, UUID strategyId, String strategy, String family, Instant openedAt,
            ...
            Integer adherencePct, Boolean setupValid, int hour, String cause, String entryTiming) {
        this(entryOrderId, instrumentId, instrument, strategyId, strategy, family, openedAt, closedAt, side, quantity, entryPrice, exitPrice, grossPaise,
                ...
                cause, entryTiming, Horizon.INTRADAY.name(), 0);
    }
