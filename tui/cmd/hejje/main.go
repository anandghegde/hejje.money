...
func rootCmd() *cobra.Command {
	...
	root.AddCommand(statusCmd(), positionsCmd(), ordersCmd(), orderCmd(), cancelCmd(), closeCmd(), closeAllCmd(),
		...
		bestCmd(), strategiesCmd(), strategyCmd(), signalsCmd(), executeCmd(), skipCmd(), pulseCmd(), aiCmd(), approvalsCmd(), approveCmd(), rejectCmd(), experimentsCmd(), basketsCmd(), splitsCmd(), chainCmd(), notifyCmd(), executorCmd(), failoverCmd())
	return root
}
