...
family: index                   # trend | mean_reversion | index | options | bot | swing   (default: trend; bot: a bot's backing strategy, docs/bots.md; swing: a swing deployment's, docs/swing.md)
